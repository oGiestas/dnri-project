...
from dnri.datasets.gnr_springs_data import GNRData
...
if __name__ == '__main__':
    ...
    name = 'springs15r3'
    train_data = GNRData(name, args.data_path, 'train', params, num_in_path=False, transpose_data=False, max_len=40)
    val_data = GNRData(name, args.data_path, 'valid', params, num_in_path=False, transpose_data=False, max_len=40)
    ...
    if args.mode == 'train':
        ...
        test_data = GNRData(name, args.data_path, 'test', params, num_in_path=False, transpose_data=False)
